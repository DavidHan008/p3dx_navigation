...
class MultiNav():  
    def __init__(self):  
        ...
        locations[0] = Pose(Point(3.311, 0.00, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))  
        locations[1] = Pose(Point(3.311,-1.987, 0.00), Quaternion(0.000, 0.000, -0.714, 0.700))  
        locations[2] = Pose(Point(4.988, -1.987, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))  
