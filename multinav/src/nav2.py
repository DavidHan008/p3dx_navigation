...
class MultiNav():  
    def __init__(self):  
        ...
        locations[0] = Pose(Point(4.987, 0.00, 0.00), Quaternion(0.000, 0.000, 0.700, 0.700))  
        locations[1] = Pose(Point(0.00,0.00, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))  
        #locations[2] = Pose(Point(3.200, 0.00, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))  
